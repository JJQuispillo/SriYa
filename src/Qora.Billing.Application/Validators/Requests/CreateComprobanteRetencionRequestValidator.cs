...
public partial class CreateComprobanteRetencionRequestValidator : AbstractValidator<CreateComprobanteRetencionRequest>
{
    ...
    public CreateComprobanteRetencionRequestValidator()
    {
        ...
        // Secuencial opcional (ausente en modo AUTO); formato 9 dígitos numéricos si está presente.
        RuleFor(x => x.Emisor.Secuencial)
            .Must(RequestValidationRules.IsValidSecuencial)
            .When(x => x.Emisor is not null && !string.IsNullOrEmpty(x.Emisor.Secuencial))
