...
namespace Qora.Billing.Infrastructure.Migrations
{
    ...
    [Migration("20260604234309_B8_AutoGenerateSecuencial")]
    partial class B8_AutoGenerateSecuencial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Qora.Billing.Domain.Entities.Document", b =>
                {
                    ...
                    b.Property<DateTime?>("RideGeneratedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("ride_generated_at");

                    b.Property<int>("RideRetryCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                    ...
                    b.HasIndex("TenantId", "DocumentType", "Estab", "PtoEmision", "Secuencial")
            ...
            modelBuilder.Entity("Qora.Billing.Domain.Entities.IdempotencyKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Qora.Billing.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.Property<bool>("AutoGenerateSecuencial")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
